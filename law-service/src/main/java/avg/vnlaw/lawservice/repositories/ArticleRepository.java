...
import avg.vnlaw.lawservice.DTO.ArticleDTOINT;
...
public interface ArticleRepository extends JpaRepository<Article,String> {
    ...
    @Query("select new avg.vnlaw.lawservice.DTO.ArticleDTO(a.id,a.name,a.content,a.index,a.vbqppl,a.vbqpplLink,a.order)" +
            " from Article a" +
