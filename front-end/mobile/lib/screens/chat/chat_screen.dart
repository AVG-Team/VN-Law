...
import 'package:mobile/screens/chat/widgets/chat_input.dart';
import 'package:mobile/screens/chat/widgets/loading_animation.dart';
import 'package:mobile/screens/chat/widgets/side_menu.dart';
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          decoration: const BoxDecoration(
            ...
            borderRadius: BorderRadius.vertical(bottom: Radius.circular(10)), // Border radius
          ),
          child: AppBar(
            title: const Text(
                'Chatbot Pháp Luật VNLAW',
  ...
  Widget _buildMessageList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final messageIndex = _isWaitingForResponse ? index - 1 : index;
