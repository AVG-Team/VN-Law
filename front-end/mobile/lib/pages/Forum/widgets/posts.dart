  ...
  import '../post_screen.dart'; // Đảm bảo import mô hình câu hỏi của bạn
  ...
  class _PostsState extends State<Posts> {
    ...
    List<Question> questions = []; // Để lưu trữ các câu hỏi đã lấy
    String? _userRole; // Giá trị khởi tạo
    @override
    void initState() {
      super.initState();
      fetchQuestions();
    ...
    Future<UserModel?> getUserWithRole() async {
      ...
      if (firebaseUser == null) {
        return null; // Trả về null nếu không có người dùng nào
      }

      // Lấy UserModel với role từ Firestore
      UserModel userModel = await UserModel.fromFirebaseUserWithRole(firebaseUser);

      return userModel; // Trả về đối tượng UserModel
    }

    Future<void> _loadUserRole() async {
      UserModel? userModel = await getUserWithRole();
      setState(() {
        _userRole = userModel?.role; // Cập nhật vai trò nếu tồn tại
      });
    }
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        formatDate(question
                                            .createdAt), // Gọi hàm formatDate để định dạng ngày
                                        style: TextStyle(
