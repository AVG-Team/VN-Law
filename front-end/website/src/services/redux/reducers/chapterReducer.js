...
const chapterReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ChapterActionTypes.GET_ALL_CHAPTERS_BY_PAGE_REQUEST:
            return { ...state, loading: true, error: null };
        case ChapterActionTypes.GET_ALL_CHAPTERS_BY_PAGE_SUCCESS:
            return { ...state, loading: false, chapters: action.payload };
        case ChapterActionTypes.GET_ALL_CHAPTERS_BY_PAGE_FAILURE:
            return { ...state, loading: false, error: action.payload };

        // Xử lý khi lấy chi tiết một chương
        case ChapterActionTypes.GET_BY_CHAPTER_REQUEST:
            return { ...state, loading: true, error: null };
        case ChapterActionTypes.GET_BY_CHAPTER_SUCCESS:
            return { ...state, loading: false, chapter: action.payload };
        case ChapterActionTypes.GET_BY_CHAPTER_FAILURE:
            return { ...state, loading: false, error: action.payload };
        ...
        // Xử lý khi lấy danh sách tất cả các chương
        case ChapterActionTypes.GET_ALL_CHAPTERS_REQUEST:
            return { ...state, loading: true, error: null };
        case ChapterActionTypes.GET_ALL_CHAPTERS_SUCCESS:
            return { ...state, loading: false, chapters: action.payload };
        case ChapterActionTypes.GET_ALL_CHAPTERS_FAILURE:
            return { ...state, loading: false, error: action.payload };
