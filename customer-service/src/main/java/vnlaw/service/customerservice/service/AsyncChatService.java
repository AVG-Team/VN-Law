...
import vnlaw.service.customerservice.dto.request.KafkaRequest;
import vnlaw.service.customerservice.util.ResponseHolder;
...
public class AsyncChatService {
    private static final String REQUEST_TOPIC = "customer-requests";
    private static final String RESPONSE_TOPIC = "customer-responses";
    ...
    public CompletableFuture<String> getAsyncAnswer(String question) {
        ...
        try {
            ...
            KafkaRequest<String> requestMessage = new KafkaRequest<String>(messageId, question);
